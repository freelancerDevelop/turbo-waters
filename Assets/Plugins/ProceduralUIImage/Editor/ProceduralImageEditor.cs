...
namespace UnityEditor.UI
{
	...
	public class ProceduralImageEditor : ImageEditor
	{
		...
		SerializedProperty m_innerShadows;
		SerializedProperty m_innerShadowColor;
		...
		protected override void OnEnable()
		{
			...
			m_borderColor = serializedObject.FindProperty("borderColor");
			m_innerShadows = serializedObject.FindProperty("innerShadows");
			m_innerShadowColor = serializedObject.FindProperty("innerShadowColor");
		...
		public override void OnInspectorGUI()
		{
			...
			m_innerShadows.vector4Value = EditorGUILayout.Vector4Field("Inner Shadows", m_innerShadows.vector4Value);

			EditorGUILayout.PropertyField(m_innerShadowColor);
