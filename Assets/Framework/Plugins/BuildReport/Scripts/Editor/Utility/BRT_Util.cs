...
public static class Util
{
	...
	public static string GetPackageFileContents(string filename)
	{
		...
		string defaultBuildReportToolFullPath = Application.dataPath + "/Framework/Plugins/" + BuildReportTool.Options.BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME;
		...
		string folderPath = BuildReportTool.Util.FindAssetFolder(Application.dataPath + "/Framework/Plugins/", BuildReportTool.Options.BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME);
