...
namespace AssetUsageDetectorNamespace
{
    ...
    public class ReferenceNode
    {
        ...
        public void DrawOnGUI( string linkToPrevNodeDescription )
        {
            ...
            if( AssetUsageDetector.showTooltips && UnityEngine.Event.current.type == EventType.Repaint && GUILayoutUtility.GetLastRect().Contains( UnityEngine.Event.current.mousePosition ) )
